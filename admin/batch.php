...
<section class="playlists">
    ...
    <div class="box-container">
        ...
        <div class="box" style="text-align: center;">
            <h3 class="title" style="margin-bottom: .5rem;">Add New Batch</h3>
            <a href="add_batch.php" class="btn">Create Batch</a>
        </div>
        ...
        <div class="box">
            ...
            <form action="" method="post" class="flex-btn">
                <input type="hidden" name="batch_id" value="<?= $fetch_batch['id']; ?>">
                <a href="update_batch.php?get_id=<?= $fetch_batch['id']; ?>" class="option-btn">Update</a>
                <input type="submit" value="Delete" class="delete-btn" onclick="return confirm('Delete this batch?');" name="delete">
            </form>
            <a href="view_batch.php?batch_id=<?= $fetch_batch['id']; ?>" class="btn">View Batch</a>
