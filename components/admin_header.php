...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logoo">NoveLearn</a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="../admin/teachers.php"><i class="fas fa-chalkboard-user"></i><span>Teachers</span></a>
      <a href="comments.php"><i class="fas fa-comment"></i><span>User Management</span></a>
