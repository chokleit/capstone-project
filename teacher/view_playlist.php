...
<section class="playlist-details">
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <a href="add_content.php?get_id=<?= $playlist_id; ?>" class="btn" style="margin-top: 1.5rem;">add new lesson</a>
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">view contents</a>
      </div>
   <?php
         }
      }else{
