...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">upload new lesson</h3>
      <a href="add_content.php" class="btn">add lesson</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_sublesson.php?lesson_id=<?= $fecth_videos['id']; ?>" class="btn">view sub-lessons</a>
