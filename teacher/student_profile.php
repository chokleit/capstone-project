...
$fname = $fetch_profile['fname'];
$lname = $fetch_profile['lname'];
$mname = $fetch_profile['mname'];
$profile_image = $fetch_profile['image'];
?>
...
<section class="profile">
   ...
   <div class="details">
      ...
      <div class="user">
         <img src="uploaded_files/<?= $profile_image; ?>" alt="">
         <h3><?= htmlspecialchars($fname . ' ' . $mname . ' ' . $lname); ?></h3>
        ...
        <a  href="update_student.php?user_id=<?= $user_id; ?>" class="inline-btn">Update Information</a>
        <a href="change.php"  class="inline-btn">Account Settings</a>
      </div>
