...
if(isset($_POST['submit'])){
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_tutor = $conn->prepare("INSERT INTO `tutors`(id, fname, mname, lname, dob, address, secretquestion, secretanswer, email, username, password, image) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
         $insert_tutor->execute([$id, $fname, $mname, $lname, $dob, $address, $email, $secretquestion, $secretanswer, $username, $cpass, $rename]);
...
<form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <input type="text" name="dob" placeholder="eneter your name" maxlength="50" class="box">
            <h2>Account</h2>
            <p>Email<span>*</span></p>
